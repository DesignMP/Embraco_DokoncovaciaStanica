...
VCUG_SOURCES_Visu=$(AS_PROJECT_PATH)/Logical/VCShared/UnitGroups/Length.vcug \
	...
	$(AS_PROJECT_PATH)/Logical/VCShared/UnitGroups/Cas.vcug \
	$(AS_PROJECT_PATH)/Logical/VCShared/UnitGroups/Rychlost.vcug \
	$(AS_PROJECT_PATH)/Logical/VCShared/UnitGroups/Teplota.vcug \
	$(AS_PROJECT_PATH)/Logical/VCShared/UnitGroups/Vzdialenost.vcug 
...
$(AS_CPU_PATH)/VCShared/vcug.Cas.vco: $(AS_PROJECT_PATH)/Logical/VCShared/UnitGroups/Cas.vcug
	 $(VCC) -f '$<' -o '$@' -l '$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr' -cv '$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo' -pal '$(PALFILE_Visu)' $(VCCFLAGS_Visu)  -p Visu -so $(VC_STATIC_OPTIONS_Visu) -vcr 4726 -sfas


$(AS_CPU_PATH)/VCShared/vcug.Rychlost.vco: $(AS_PROJECT_PATH)/Logical/VCShared/UnitGroups/Rychlost.vcug
	 $(VCC) -f '$<' -o '$@' -l '$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr' -cv '$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo' -pal '$(PALFILE_Visu)' $(VCCFLAGS_Visu)  -p Visu -so $(VC_STATIC_OPTIONS_Visu) -vcr 4726 -sfas


$(AS_CPU_PATH)/VCShared/vcug.Teplota.vco: $(AS_PROJECT_PATH)/Logical/VCShared/UnitGroups/Teplota.vcug
	 $(VCC) -f '$<' -o '$@' -l '$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr' -cv '$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo' -pal '$(PALFILE_Visu)' $(VCCFLAGS_Visu)  -p Visu -so $(VC_STATIC_OPTIONS_Visu) -vcr 4726 -sfas


$(AS_CPU_PATH)/VCShared/vcug.Vzdialenost.vco: $(AS_PROJECT_PATH)/Logical/VCShared/UnitGroups/Vzdialenost.vcug
	 $(VCC) -f '$<' -o '$@' -l '$(AS_PROJECT_PATH)/Logical/VCShared/Languages.vcr' -cv '$(AS_PROJECT_PATH)/Logical/VCShared/ControlVersion.cvinfo' -pal '$(PALFILE_Visu)' $(VCCFLAGS_Visu)  -p Visu -so $(VC_STATIC_OPTIONS_Visu) -vcr 4726 -sfas
