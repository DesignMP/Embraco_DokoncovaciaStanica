...
export WIN32_AS_PROJECT_PATH := "D:\Projekty BER\Embraco_DokoncovaciaStanica"
export WIN32_AS_SYSTEM_PATH := "C:\BrAutomation\AS\System"
export WIN32_AS_VC_PATH := "C:\BrAutomation\AS410\AS\VC"
export WIN32_AS_TEMP_PATH := "D:\Projekty BER\Embraco_DokoncovaciaStanica\Temp"
export WIN32_AS_BINARIES_PATH := "D:\Projekty BER\Embraco_DokoncovaciaStanica\Binaries"
...
ProjectMakeFile:
	...
	@'$(AS_BIN_PATH)/4.9/BR.AS.AnalyseProject.exe' '$(AS_PROJECT_PATH)/Embraco_LinkaNaOdlievanieRotorov_DokoncovaciaStanica_Rev2.apj' -t '$(AS_TEMP_PATH)' -c '$(AS_CONFIGURATION)' -o '$(AS_BINARIES_PATH)'   -sfas -buildMode 'Rebuild'   
